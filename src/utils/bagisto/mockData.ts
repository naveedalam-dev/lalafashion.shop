...
const baseProducts = [
    ...
    },
    {
        ...
        description: "<p>Sink into luxury with this modern lounge chair, crafted with premium materials and solid wood legs. Ergonomically designed for maximum comfort — perfect for your office or premium living space.</p>",
    ...
    },
    {
        ...
        urlKey: "premium-desk-lamp",
        description: "<p>A clean, minimalist desk lamp that serves as the perfect Addition to any modern workspace. Crafted from high-grade metals with a premium finish and adjustable brightness.</p>",
        shortDescription: "Clean minimalist desk lamp with premium metallic finish.",
        price: 35.0,
