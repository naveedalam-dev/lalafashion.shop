        ...
        <div className="bg-white dark:bg-background min-h-screen font-outfit text-slate-900 dark:text-foreground">
            ...
            <header className="relative pt-24 pb-16 overflow-hidden border-b border-slate-100 dark:border-neutral-900">
                ...
                <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-4xl mx-auto">
                    ...
                    <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-6">
                        Delivery <span className="text-blue-600">Policy</span>
                    </h1>
                    <p className="text-lg text-slate-500 dark:text-neutral-400 font-normal max-w-2xl leading-relaxed">
                        We are committed to delivering exactly the same product in terms of design, color, size, and brand as displayed on our website.
                    </p>
                </div>
            </header>
            ...
            <main className="max-w-4xl mx-auto px-6 py-20">
                <div className="prose prose-slate dark:prose-invert max-w-none space-y-12">
                    <section>
                        ...
                        <p className="text-slate-600 dark:text-neutral-400 leading-relaxed md:text-sm">
                            To ensure accurate delivery, we collect additional information during checkout (such as alternate contact numbers or nearby landmarks). This helps courier services locate customer addresses more efficiently.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-slate-600 dark:text-neutral-400 leading-relaxed md:text-sm">
                            Orders are delivered within <strong>3 to 5 working days</strong> across Pakistan.
                        </p>
                    </section>
                </div>
                ...
                <div className="mt-20 p-10 rounded-[3rem] bg-blue-600 text-white text-center shadow-xl shadow-blue-500/20">
                    <h3 className="text-2xl font-bold mb-4">Questions about your delivery?</h3>
                    <p className="text-blue-100 mb-8 font-medium">Reach out to our customer support team.</p>
                    <Link 
                        href="/contact"
